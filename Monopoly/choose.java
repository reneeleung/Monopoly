...
public class choose extends JPanel{
  ...
  public choose(){
    super();
    try{
      bcg1 = ImageIO.read(getClass().getResource("images/select1.png"));
      bcg2 = ImageIO.read(getClass().getResource("images/select2.png"));
      bcg3 = ImageIO.read(getClass().getResource("images/select3.png"));
      bcg4 = ImageIO.read(getClass().getResource("images/select4.png"));  
